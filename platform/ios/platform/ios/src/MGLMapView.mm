...
//  self.isAccessibilityElement = YES;
    ...
    std::optional<std::string> localFontFamilyName = config.localFontFamilyName ? std::optional<std::string>(std::string(config.localFontFamilyName.UTF8String)) : mbgl::std::nullopt;
...
- (void)cameraWillChangeAnimated:(BOOL)animated {
            ...
            || self.userTrackingState != MGLUserTrackingStateChanged)
    {
        ...
        // dismissesAutomatically is an std::optional property and we want to dismiss
