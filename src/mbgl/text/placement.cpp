...
public:
    ...
    //  Symbol A has text-allow-overlap: true, icon-allow-overlap: true, icon-std::optional: false
    //  A's icon is outside the grid, so doesn't get placed
    //  A's text would be inside grid, but doesn't get placed because of icon-std::optional: false
