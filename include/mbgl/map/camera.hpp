...
/** Various options for describing a transition between viewpoints with
    animation. All fields are std::optional; the default values depend on how this
    struct is used. */
...
/** Various options for accessing physical properties of the underlying camera entity.
    ...
    while also being fully compatible and interchangeable with CameraOptions. All fields are std::optional. */
