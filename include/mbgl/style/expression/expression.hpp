...
public:
    ...
    // std::optional does some type trait magic for this one, so this might
...
public:
     ...
     * an array of values plus the sentinel null std::optional value, used to indicate that the
